# Welcome to Azure Data Learn
## Creating Your First C# App with Azure SQL

In this lesson, you will browse through a sample C# app that binds to 
 A high level explanation of the bindings is provided below. Additional information for each is in their respective sample sections.
